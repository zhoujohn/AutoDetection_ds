...
public class RxToast {
    ...
    public static void normal(@NonNull String message) {
        ...
        normal(AppConfig.getInstance().mAppContext, message, Toast.LENGTH_SHORT, null, false).show();
    }

    public static void normal(@NonNull String message, Drawable icon) {
        normal(AppConfig.getInstance().mAppContext, message, Toast.LENGTH_SHORT, icon, true).show();
    }

    public static void normal(@NonNull String message, int duration) {
        normal(AppConfig.getInstance().mAppContext, message, duration, null, false).show();
    }

    public static void normal(@NonNull String message, int duration, Drawable icon) {
        normal(AppConfig.getInstance().mAppContext, message, duration, icon, true).show();
    }

    public static Toast normal(@NonNull String message, int duration, Drawable icon, boolean withIcon) {
        return custom(AppConfig.getInstance().mAppContext, message, icon, DEFAULT_TEXT_COLOR, duration, withIcon);
    }

    public static void warning(@NonNull String message) {
        warning(AppConfig.getInstance().mAppContext, message, Toast.LENGTH_SHORT, true).show();
    }

    public static void warning(@NonNull String message, int duration) {
        warning(AppConfig.getInstance().mAppContext, message, duration, true).show();
    }

    public static Toast warning(@NonNull String message, int duration, boolean withIcon) {
        return custom(AppConfig.getInstance().mAppContext, message, getDrawable(AppConfig.getInstance().mAppContext, R.drawable.ic_error_outline_white_48dp), DEFAULT_TEXT_COLOR, WARNING_COLOR, duration, withIcon, true);
    }

    public static void info(@NonNull String message) {
        info(AppConfig.getInstance().mAppContext, message, Toast.LENGTH_SHORT, true).show();
    }

    public static void info(@NonNull String message, int duration) {
        info(AppConfig.getInstance().mAppContext, message, duration, true).show();
    }

    public static Toast info(@NonNull String message, int duration, boolean withIcon) {
        return custom(AppConfig.getInstance().mAppContext, message, getDrawable(AppConfig.getInstance().mAppContext, R.drawable.ic_info_outline_white_48dp), DEFAULT_TEXT_COLOR, INFO_COLOR, duration, withIcon, true);
    }

    public static void success(@NonNull String message) {
        success(AppConfig.getInstance().mAppContext, message, Toast.LENGTH_SHORT, true).show();
    }

    public static void success(@NonNull String message, int duration) {
        success(AppConfig.getInstance().mAppContext, message, duration, true).show();
    }

    public static Toast success(@NonNull String message, int duration, boolean withIcon) {
        return custom(AppConfig.getInstance().mAppContext, message, getDrawable(AppConfig.getInstance().mAppContext, R.drawable.ic_check_white_48dp), DEFAULT_TEXT_COLOR, SUCCESS_COLOR, duration, withIcon, true);
    }

    public static void error(@NonNull String message) {
        error(AppConfig.getInstance().mAppContext, message, Toast.LENGTH_SHORT, true).show();
    }
    ...
    public static void error(@NonNull String message, int duration) {
        error(AppConfig.getInstance().mAppContext, message, duration, true).show();
    }

    public static Toast error(@NonNull String message, int duration, boolean withIcon) {
        return custom(AppConfig.getInstance().mAppContext, message, getDrawable(AppConfig.getInstance().mAppContext, R.drawable.ic_clear_white_48dp), DEFAULT_TEXT_COLOR, ERROR_COLOR, duration, withIcon, true);
    }
    ...
    public static void showToastShort(String str) {
        Toast.makeText(AppConfig.getInstance().mAppContext, str, Toast.LENGTH_SHORT).show();
    }
    ...
    public static void showToastShort(int resId) {
        Toast.makeText(AppConfig.getInstance().mAppContext, AppConfig.getInstance().mAppContext.getString(resId), Toast.LENGTH_SHORT).show();
    }
    ...
    public static void showToastLong(String str) {
        Toast.makeText(AppConfig.getInstance().mAppContext, str, Toast.LENGTH_LONG).show();
    }
    ...
    public static void showToastLong(int resId) {
        Toast.makeText(AppConfig.getInstance().mAppContext, AppConfig.getInstance().mAppContext.getString(resId), Toast.LENGTH_LONG).show();
    }
...
//            Looper.prepare();
                mToast = Toast.makeText(AppConfig.getInstance().mAppContext, msg, Toast.LENGTH_LONG);
//            Looper.loop();
            } else {
                Looper.prepare();
                mToast = Toast.makeText(AppConfig.getInstance().mAppContext, msg, Toast.LENGTH_LONG);
    ...
    public static void showToast(int resId) {
        if (mToast == null) {
            mToast = Toast.makeText(AppConfig.getInstance().mAppContext, AppConfig.getInstance().mAppContext.getString(resId), Toast.LENGTH_LONG);
        } else {
            mToast.setText(AppConfig.getInstance().mAppContext.getString(resId));
        }
        mToast.show();
    }
